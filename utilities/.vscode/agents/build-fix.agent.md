...
- `.vscode/instructions/skills/build-analysis.instructions.md` — parses Jenkins/Maven logs, classifies failure types, suggests targeted fixes
...
7. Stage and commit fix: `<STORY-ID>: Fix <failure-type> — <brief description>`.
