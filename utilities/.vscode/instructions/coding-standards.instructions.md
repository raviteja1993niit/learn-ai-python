---
applyTo: '**'
description: 'Java 17 / Spring Boot 3.x coding standards for Mastercard PGS Connectivity projects: language version, copyright header, naming conventions, formatting, Spring practices, immutability, Lombok, exceptions, logging, and layer separation.'
---
