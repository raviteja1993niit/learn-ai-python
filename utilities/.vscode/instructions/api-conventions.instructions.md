---
applyTo: '**'
description: 'REST API design conventions for Mastercard PGS Connectivity acquirer interface services: URI structure, HTTP status codes, request/response design, versioning, pagination, security, and documentation.'
---
