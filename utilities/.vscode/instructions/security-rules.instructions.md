---
applyTo: '**'
description: 'Security rules for Mastercard PGS Connectivity projects: secrets management, PCI/PII data handling, input validation, OWASP Top 10 checklist, TLS requirements, dependency hygiene, log hygiene, and error handling.'
---
