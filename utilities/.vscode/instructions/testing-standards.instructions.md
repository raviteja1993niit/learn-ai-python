---
applyTo: '**'
description: 'Testing standards for Mastercard PGS Connectivity projects: coverage targets, test naming conventions (should*When*), Arrange-Act-Assert pattern, frameworks (JUnit 5, Mockito, AssertJ, WireMock), mocking rules, test data guidelines, edge cases, integration test isolation, and disabled test policy.'
---
