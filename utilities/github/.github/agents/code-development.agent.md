...
- .github/instructions/enterprise-java-development.instructions.md — coding standards, Java 17, Spring Boot, Lombok, layers
- .github/instructions/security-rules.instructions.md — OWASP, PCI/PII, logging hygiene
- llm-cost-optimizer — universal cost discipline; always-on: go straight to the answer, bounded context, single-pass execution
