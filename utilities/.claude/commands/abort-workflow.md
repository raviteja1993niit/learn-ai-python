...
argument-hint: >
  Pass the story ID and optional abort reason, e.g. "PROJ-1234" or "PROJ-1234 --reason 'Requirements changed'"
---

# /project:abort-workflow

Immediately pause the SDLC pipeline for a story. The current phase is halted and the state is
preserved so the pipeline can be resumed later via `/project:start-workflow PROJ-1234 --phase N`.

## Usage

```
/project:abort-workflow PROJ-1234
/project:abort-workflow PROJ-1234 --reason "Requirements changed — awaiting updated AC"
```
...
```
/project:start-workflow PROJ-1234 --phase <N>
```
